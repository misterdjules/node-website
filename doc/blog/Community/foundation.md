...
of Node.js. Please review them [here](https://github.com/joyent/nodejs-advisory-board/tree/master/governance-proposal).

With the recent vote by the io.js TSC to join the Node.js Foundation, we took
a giant leap toward rebuilding a unified community.  @mikeal, @piscisaureus
and others have done an excellent job evangelizing the value of the
Foundation, and it’s great to see it have such positive impact this early in
its formation.
...
javascript platform, and everyone wins. If we get it wrong, the market will
move to an alternate platform, and everyone loses.
